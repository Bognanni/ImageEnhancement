...
class AttentionUNet(nn.Module):
    """
    A UNet variant that incorporates CBAM attention blocks in the decoding pathway.
    """
    def __init__(self, n_channels=3, n_classes=3, bilinear=True):
        ...
        # Decoding with Attention Blocks
